...
int lgw_spi_open(void **spi_target_ptr) {
	...
	printf("######################packet_forwarder/poly_pkt_fwd/src/loragw_spi.native.c:  SPI Open \n");
...
int lgw_spi_w(void *spi_target, uint8_t address, uint8_t data) {
	...
	DEBUG_MSG("##################################################Simple Write SPI loragw_spi.native.c\n");
...
int lgw_spi_r(void *spi_target, uint8_t address, uint8_t *data) {
	...
	DEBUG_MSG("##################################################Simple Read SPI loragw_spi.native.c\n");
...
int lgw_spi_wb(void *spi_target, uint8_t address, uint8_t *data, uint16_t size) {
	...
	DEBUG_MSG("##################################################Burst Write SPI loragw_spi.native.c\n");
