...
void sx125x_write(uint8_t channel, uint8_t addr, uint8_t data) {
	...
	//printf("######################lora_gateway/libloragw/src/loragw_hal.c:  sx1257 write \n");
...
uint8_t sx125x_read(uint8_t channel, uint8_t addr) {
	...
	//printf("######################lora_gateway/libloragw/src/loragw_hal.c:  sx1257 read \n");
...
int lgw_start(void) {
	...
	printf("######################lora_gateway/libloragw/src/loragw_hal.c:  lgw_start() \n");
	printf("######################lora_gateway/libloragw/src/loragw_hal.c:  Concentrator: %s\n", SPI_DEV_PATH);
	...
	*/
	...
	lgw_is_started = true;
	printf("######################lora_gateway/libloragw/src/loragw_hal.c:  EOF lgw_start() \n");
	return LGW_HAL_SUCCESS;
}
...
int lgw_stop(void) {
	printf("######################lora_gateway/libloragw/src/loragw_hal.c:  lgw_stop() \n");
	lgw_soft_reset();
	lgw_disconnect();
...
int lgw_receive(uint8_t max_pkt, struct lgw_pkt_rx_s *pkt_data) {
	...
	//printf("######################lora_gateway/libloragw/src/loragw_hal.c:  lgw_receive() \n");
	...
	//printf("######################lora_gateway/libloragw/src/loragw_hal.c:  EOF lgw_receive() \n");
